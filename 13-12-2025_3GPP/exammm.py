...
import os
print(os.getcwd())
print(os.path.exists("3GPP_API_ASSIGNMENT/yamls/TS29502_Nsmf_PDUSession.yaml"))
...
# ---- File Path ----
url = "3GPP_API_ASSIGNMENT/yamls/TS29502_Nsmf_PDUSession.yaml"

# ---- Logging Setup ----
log_file = "3GPP_API_ASSIGNMENT/log.txt"
err_file = "3GPP_API_ASSIGNMENT/err.txt"
...
try:
    ...
    out_file = r"C:\Users\N.Janardhan Reddy\Downloads\3GPP\3GPP_API_ASSIGNMENT\output.json"
    ...
    summary_file = r"C:\Users\N.Janardhan Reddy\Downloads\3GPP\3GPP_API_ASSIGNMENT\summary.txt"
    ...
    raise APIResponseError("Unknown error occurred while processing YAML file")
